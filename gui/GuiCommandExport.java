 ...
 */
public class GuiCommandExport extends NotUndoableStateChangingCommand {
     ...
     */
    public GuiCommandExport(final String sourceCode, final SpreadsheetViewTableModel spreadsheetView) {
        super();
    ...
    public void doit() {
        ...
        if (parser.currentTokenMatches(TokenType.END_OF_FILE)) {
            ...
            ImputOutput.generateCsvFile(filePathName, spreadsheetView.getSpreadsheet());
            setLastOperationOk();
        }
    }
